			...
			(function (e)
			{
				(function ()
				{
					(function ()
					{
						...
						function f(e)
						{
							return e = x(e), /^(?:webOS|i(?:OS|P))/.test(e) ? e : p(e)
						}
						...
						var y = function e(t)
						{
							...
							var l, s, c, d, p, y = r ? !!o.likeChrome : /\bChrome\b/.test(t) && !/internal|\n/i.test(b.toString()),
								...
								M = r ? v : "RuntimeObject",
								P = /\bJava/.test(E) && n.java,
								I = P && g(n.environment) == O,
								A = P ? "a" : "α",
								C = P ? "b" : "β",
								k = n.document ||
								{},
								R = n.operamini || n.opera,
								B = u.test(B = r && R ? R["[[Class]]"] : g(R)) ? B : R = null,
								W = t,
								$ = [],
								T = null,
								F = t == a,
								j = F && R && "function" == typeof R.version && R.version(),
								G = m([
								{
									label: "EdgeHTML",
									pattern: "Edge"
								...
								K = function (e)
								{
									return m(e, (function (e, n)
									{
										...
										return !e && (e = RegExp("\\b" + r + "(?:/[\\d.]+|[ \\w.]*)", "i").exec(t)) && (e = function (e, t, n)
										{
											...
											return t && n && /^Win/i.test(e) && !/^Windows Phone /i.test(e) && (r = r[/[\d.]+$/.exec(e)]) && (e = "Windows " + r), e = String(e), t && n && (e = e.replace(RegExp(t, "i"), n)), f(e.replace(/ ce$/i, " CE").replace(/\bhpw/i, "web").replace(/\bMacintosh\b/, "Mac OS").replace(/_PowerPC\b/i, " OS").replace(/\b(OS X) [^ \d]+/i, "$1").replace(/\bMac (OS X)\b/, "$1").replace(/\/(\d)/, " $1").replace(/_/g, ".").replace(/(?: BePC|[ .]*fc[ \d.]+)$/i, "").replace(/\bx86\.64\b/gi, "x86_64").replace(/\b(Windows Phone) OS\b/, "$1").replace(/\b(Chrome OS \w+) [\d.]+\b/, "$1").split(" on ")[0])
										}(e, r, n.label || n)), e
									}))
							...
							if (G && (G = [G]), /\bAndroid\b/.test(K) && !X && (l = /\bAndroid[^;]*;(.*?)(?:Build|\) AppleWebKit)\b/i.exec(t)) && (X = x(l[1]).replace(/^[a-z]{2}-[a-z]{2};\s*/i, "") || null), D && !X ? X = L([D]) : D && X && (X = X.replace(RegExp("^(" + S(D) + ")[-_.\\s]", "i"), D + " ").replace(RegExp("^(" + S(D) + ")[-_.]?(\\w)", "i"), D + " $2")), (l = /\bGoogle TV\b/.exec(X)) && (X = l[0]), /\bSimulator\b/i.test(t) && (X = (X ? X + " " : "") + "Simulator"), "Opera Mini" == N && /\bOPiOS\b/.test(t) && $.push("running in Turbo/Uncompressed mode"), "IE" == N && /\blike iPhone OS\b/.test(t) ? (D = (l = e(t.replace(/like iPhone OS/, ""))).manufacturer, X = l.product) : /^iP/.test(X) ? (N || (N = "Safari"), K = "iOS" + ((l = / OS ([\d_]+)/i.exec(t)) ? " " + l[1].replace(/_/g, ".") : "")) : "Konqueror" == N && /^Linux\b/i.test(K) ? K = "Kubuntu" : D && "Google" != D && (/Chrome/.test(N) && !/\bMobile Safari\b/i.test(t) || /\bVita\b/.test(X)) || /\bAndroid\b/.test(K) && /^Chrome/.test(N) && /\bVersion\//i.test(t) ? (N = "Android Browser", K = /\bAndroid\b/.test(K) ? K : "Android") : "Silk" == N ? (/\bMobi/i.test(t) || (K = "Android", $.unshift("desktop mode")), /Accelerated *= *true/i.test(t) && $.unshift("accelerated")) : "UC Browser" == N && /\bUCWEB\b/.test(t) ? $.push("speed mode") : "PaleMoon" == N && (l = /\bFirefox\/([\d.]+)\b/.exec(t)) ? $.push("identifying as Firefox " + l[1]) : "Firefox" == N && (l = /\b(Mobile|Tablet|TV)\b/i.exec(t)) ? (K || (K = "Firefox OS"), X || (X = l[1])) : !N || (l = !/\bMinefield\b/i.test(t) && /\b(?:Firefox|Safari)\b/.exec(N)) ? (N && !X && /[\/,]|^[^(]+?\)/.test(t.slice(t.indexOf(l + "/") + 8)) && (N = null), (l = X || D || K) && (X || D || /\b(?:Android|Symbian OS|Tablet OS|webOS)\b/.test(K)) && (N = /[a-z]+(?: Hat)?/i.exec(/\bAndroid\b/.test(K) ? K : l) + " Browser")) : "Electron" == N && (l = (/\bChrome\/([\d.]+)\b/.exec(t) || 0)[1]) && $.push("Chromium " + l), j || (j = V(["(?:Cloud9|CriOS|CrMo|Edge|Edg|EdgA|EdgiOS|FxiOS|HeadlessChrome|IEMobile|Iron|Opera ?Mini|OPiOS|OPR|Raven|SamsungBrowser|Silk(?!/[\\d.]+$)|UCBrowser|YaBrowser)", "Version", S(N), "(?:Firefox|Minefield|NetFront)"])), (l = ("iCab" == G && parseFloat(j) > 3 ? "WebKit" : /\bOpera\b/.test(N) && (/\bOPR\b/.test(t) ? "Blink" : "Presto")) || /\b(?:Midori|Nook|Safari)\b/i.test(t) && !/^(?:Trident|EdgeHTML)$/.test(G) && "WebKit" || !G && /\bMSIE\b/i.test(t) && ("Mac OS" == K ? "Tasman" : "Trident") || "WebKit" == G && /\bPlayStation\b(?! Vita\b)/i.test(N) && "NetFront") && (G = [l]), "IE" == N && (l = (/; *(?:XBLWP|ZuneWP)(\d+)/i.exec(t) || 0)[1]) ? (N += " Mobile", K = "Windows Phone " + (/\+$/.test(l) ? l : l + ".x"), $.unshift("desktop mode")) : /\bWPDesktop\b/i.test(t) ? (N = "IE Mobile", K = "Windows Phone 8.x", $.unshift("desktop mode"), j || (j = (/\brv:([\d.]+)/.exec(t) || 0)[1])) : "IE" != N && "Trident" == G && (l = /\brv:([\d.]+)/.exec(t)) && (N && $.push("identifying as " + N + (j ? " " + j : "")), N = "IE", j = l[1]), F)
							{
								...
								else if (P && (W = (l = P.lang.System).getProperty("os.arch"), K = K || l.getProperty("os.name") + " " + l.getProperty("os.version")), I)
								{
									try
									{
										j = n.require("ringo/engine").version.join("."), N = "RingoJS"
									}
									catch (e)
									{
										(l = n.system) && l.global.system == n.system && (N = "Narwhal", K || (K = l[0].os || null))
									}
									N || (N = "Rhino")
								}
								else "object" == typeof n.process && !n.process.browser && (l = n.process) && ("object" == typeof l.versions && ("string" == typeof l.versions.electron ? ($.push("Node " + l.versions.node), N = "Electron", j = l.versions.electron) : "string" == typeof l.versions.nw && ($.push("Chromium " + j, "Node " + l.versions.node), N = "NW.js", j = l.versions.nw)), N || (N = "Node.js", W = l.arch, K = l.platform, j = (j = /[\d.]+/.exec(l.version)) ? j[0] : null));
								K = K && f(K)
							}
							if (j && (l = /(?:[ab]|dp|pre|[ab]\d+pre)(?:\d+\+?)?$/i.exec(j) || /(?:alpha|beta)(?: ?\d)?/i.exec(t + ";" + (F && o.appMinorVersion)) || /\bMinefield\b/i.test(t) && "a") && (T = /b/i.test(l) ? "beta" : "alpha", j = j.replace(RegExp(l + "\\+?$"), "") + ("beta" == T ? C : A) + (/\d+\+?/.exec(l) || "")), "Fennec" == N || "Firefox" == N && /\b(?:Android|Firefox OS|KaiOS)\b/.test(K)) N = "Firefox Mobile";
							else if ("Maxthon" == N && j) j = j.replace(/\.[\d.]+/, ".x");
							else if (/\bXbox\b/i.test(X)) "Xbox 360" == X && (K = null), "Xbox 360" == X && /\bIEMobile\b/.test(t) && $.unshift("mobile mode");
							...
							else(/\bBlackBerry\b/.test(X) || /\bBB10\b/.test(t)) && (l = (RegExp(X.replace(/ +/g, " *") + "/([.\\d]+)", "i").exec(t) || 0)[1] || j) ? (K = ((l = [l, /BB10/.test(t)])[1] ? (X = null, D = "BlackBerry") : "Device Software") + " " + l[0], j = null) : this != h && "Wii" != X && (F && R || /Opera/.test(N) && /\b(?:MSIE|Firefox)\b/i.test(t) || "Firefox" == N && /\bOS X (?:\d+\.){2,}/.test(K) || "IE" == N && (K && !/^Win/.test(K) && j > 5.5 || /\bWindows XP\b/.test(K) && j > 8 || 8 == j && !/\bTrident\b/.test(t))) && !u.test(l = e.call(h, t.replace(u, "") + ";")) && l.name && (l = "ing as " + l.name + ((l = l.version) ? " " + l : ""), u.test(N) ? (/\bIE\b/.test(l) && "Mac OS" == K && (K = null), l = "identify" + l) : (l = "mask" + l, N = B ? f(B.replace(/([a-z])([A-Z])/g, "$1 $2")) : "Opera", /\bIE\b/.test(l) && (K = null), F || (j = null)), G = ["Presto"], $.push(l));
							else N += " Mobile";
							(l = (/\bAppleWebKit\/([\d.]+\+?)/i.exec(t) || 0)[1]) && (l = [parseFloat(l.replace(/\.(\d)$/, ".0$1")), l], "Safari" == N && "+" == l[1].slice(-1) ? (N = "WebKit Nightly", T = "alpha", j = l[1].slice(0, -1)) : j != l[1] && j != (l[2] = (/\bSafari\/([\d.]+\+?)/i.exec(t) || 0)[1]) || (j = null), l[1] = (/\b(?:Headless)?Chrome\/([\d.]+)/i.exec(t) || 0)[1], 537.36 == l[0] && 537.36 == l[2] && parseFloat(l[1]) >= 28 && "WebKit" == G && (G = ["Blink"]), F && (y || l[1]) ? (G && (G[1] = "like Chrome"), l = l[1] || ((l = l[0]) < 530 ? 1 : l < 532 ? 2 : l < 532.05 ? 3 : l < 533 ? 4 : l < 534.03 ? 5 : l < 534.07 ? 6 : l < 534.1 ? 7 : l < 534.13 ? 8 : l < 534.16 ? 9 : l < 534.24 ? 10 : l < 534.3 ? 11 : l < 535.01 ? 12 : l < 535.02 ? "13+" : l < 535.07 ? 15 : l < 535.11 ? 16 : l < 535.19 ? 17 : l < 536.05 ? 18 : l < 536.1 ? 19 : l < 537.01 ? 20 : l < 537.11 ? "21+" : l < 537.13 ? 23 : l < 537.18 ? 24 : l < 537.24 ? 25 : l < 537.36 ? 26 : "Blink" != G ? "27" : "28")) : (G && (G[1] = "like Safari"), l = (l = l[0]) < 400 ? 1 : l < 500 ? 2 : l < 526 ? 3 : l < 533 ? 4 : l < 534 ? "4+" : l < 535 ? 5 : l < 537 ? 6 : l < 538 ? 7 : l < 601 ? 8 : l < 602 ? 9 : l < 604 ? 10 : l < 606 ? 11 : l < 608 ? 12 : "12"), G && (G[1] += " " + (l += "number" == typeof l ? ".x" : /[.+]/.test(l) ? "" : "+")), "Safari" == N && (!j || parseInt(j) > 45) ? j = l : "Chrome" == N && /\bHeadlessChrome/i.test(t) && $.unshift("headless")), "Opera" == N && (l = /\bzbov|zvav$/.exec(K)) ? (N += " ", $.unshift("desktop mode"), "zvav" == l ? (N += "Mini", j = null) : N += "Mobile", K = K.replace(RegExp(" *" + l + "$"), "")) : "Safari" == N && /\bChrome\b/.exec(G && G[1]) ? ($.unshift("desktop mode"), N = "Chrome Mobile", j = null, /\bOS X\b/.test(K) ? (D = "Apple", K = "iOS 4.3+") : K = null) : /\bSRWare Iron\b/.test(N) && !j && (j = V("Chrome")), j && 0 == j.indexOf(l = /[\d.]+$/.exec(K)) && t.indexOf("/" + l + "-") > -1 && (K = x(K.replace(l, ""))), K && -1 != K.indexOf(N) && !RegExp(N + " OS").test(K) && (K = K.replace(RegExp(" *" + S(N) + " *"), "")), G && !/\b(?:Avant|Nook)\b/.test(N) && (/Browser|Lunascape|Maxthon/.test(N) || "Safari" != N && /^iOS/.test(K) && /\bSafari\b/.test(G[1]) || /^(?:Adobe|Arora|Breach|Midori|Opera|Phantom|Rekonq|Rock|Samsung Internet|Sleipnir|SRWare Iron|Vivaldi|Web)/.test(N) && G[1]) && (l = G[G.length - 1]) && $.push(l), $.length && ($ = ["(" + $.join("; ") + ")"]), D && X && X.indexOf(D) < 0 && $.push("on " + D), X && $.push((/^on /.test($[$.length - 1]) ? "" : "on ") + X), K && (l = / ([\d.+]+)$/.exec(K), s = l && "/" == K.charAt(K.length - l[0].length - 1), K = {
								architecture: 32,
							...
							}), (l = /\b(?:AMD|IA|Win|WOW|x86_|x)64\b/i.exec(W)) && !/\bi686\b/i.test(W) ? (K && (K.architecture = 64, K.family = K.family.replace(RegExp(" *" + l), "")), N && (/\bWOW64\b/i.test(t) || F && /\w(?:86|32)$/.test(o.cpuClass || o.platform) && !/\bWin64; x64\b/i.test(t)) && $.unshift("32-bit")) : K && /^OS X/.test(K.family) && "Chrome" == N && parseFloat(j) >= 39 && (K.architecture = 64), t || (t = null);
							var _ = {};
							return _.description = t, _.layout = G && G[0], _.manufacturer = D, _.name = N, _.prerelease = T, _.product = X, _.ua = t, _.version = N && j, _.os = K ||
							{
								architecture: null,
								family: null,
								version: null,
							...
							}, _.version && $.unshift(j), _.name && $.unshift(N), K && N && (K != String(K).split(" ")[0] || K != N.split(" ")[0] && !X) && $.push(X ? "(" + K + ")" : "on " + K), $.length && (_.description = $.join(" ")), _
						}();
		...
		2: [function (e, t, n)
		{
			...
			var p = function (e, t)
				...
				h = function (e, t, n, r)
				{
					...
					{
						if (200 !== i.status) throw new Error("Server returned with an unhandled status");
						var e = null;
						try
						{
						...
						if (null != e.errors) throw new Error(e.errors[0].message);
						if ("function" == typeof r) return r(e)
					}, i.setRequestHeader("Content-Type", "application/json;charset=UTF-8"), i.withCredentials = n.ignoreOwnVisits, i.send(JSON.stringify(t))
				},
				g = function ()
				{
			...
			var S = function (e, t)
			{
				t = function ()
				{
					var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] :
						{},
						t = {};
					return t.detailed = !0 === e.detailed, t.ignoreLocalhost = !1 !== e.ignoreLocalhost, t.ignoreOwnVisits = !1 !== e.ignoreOwnVisits, t
				}(t);
				...
				if (!0 === t.ignoreLocalhost && !0 == ("" === (n = location.hostname) || "localhost" === n || "127.0.0.1" === n || "::1" === n)) return console.warn("Ackee ignores you because you are on localhost"), a;
				if (!0 === (r = navigator.userAgent, /bot|crawler|spider|crawling/i.test(r))) return console.warn("Ackee ignores you because you are a bot"), a;
				return {
					record: function (e)
					{
						...
						return h(i, p(e, n), t, (function (e)
						{
							...
							if (!0 === u(n)) return console.warn("Ackee ignores you because this is your own site");
					...
					updateRecord: function (e)
					{
						...
						if (!0 === u(e)) return console.warn("Ackee ignores you because this is your own site"),
						{
							stop: r
						};
